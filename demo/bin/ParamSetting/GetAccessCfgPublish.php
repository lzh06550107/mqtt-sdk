...
use JuLongDeviceMqtt\ParamSetting\Models\GetAccessCfgRequest;
...
$getAccessCfgRequest = new GetAccessCfgRequest();

// TODO 未测试，设备不支持
Coroutine\run(function () use($paramSettingMqttClient, $getAccessCfgRequest) {
//    while (true) {
    $response = $paramSettingMqttClient->publish('fwSkNfgI4JKljlkM', $getAccessCfgRequest, 1);
    var_dump($response);
    Coroutine::sleep(3);
//    }
});