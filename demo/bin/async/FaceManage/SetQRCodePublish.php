...
use JuLongDeviceMqtt\FaceManage\Models\SetQRCodeRequest;
...
$setQRCodeRequest = new SetQRCodeRequest();
$setQRCodeRequest->PictureType = 0;
$setQRCodeRequest->PictureFormat = 0;
$setQRCodeRequest->QRCodeUrl = ''; // 二维码下载路径

// TODO 未测试
Coroutine\run(function () use($faceManageBaseMqttClient, $setQRCodeRequest) {
//    while (true) {
    $response = $faceManageBaseMqttClient->publish('fwSkNfgI4JKljlkM', $setQRCodeRequest, 1);
    var_dump($response);
    Coroutine::sleep(3);
//    }
});