...
use JuLongDeviceMqtt\ParamSetting\Models\IOControlRequest;
...
$IOControlRequest = new IOControlRequest();
$IOControlRequest->setContinueSeconds(3);

Coroutine\run(function () use($paramSettingMqttClient, $IOControlRequest) {
//    while (true) {
    $paramSettingMqttClient->publish('fwSkNfgI4JKljlkM', $IOControlRequest, MQTT_QOS_0);
    Coroutine::sleep(3);
//    }
});