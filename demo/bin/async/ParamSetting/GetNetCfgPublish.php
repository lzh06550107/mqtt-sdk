...
use JuLongDeviceMqtt\ParamSetting\Models\GetNetCfgRequest;
...
$getNetCfgRequest = new GetNetCfgRequest();

Coroutine\run(function () use ($paramSettingMqttClient, $getNetCfgRequest) {
//    while (true) {
    $response = $paramSettingMqttClient->publish('fwSkNfgI4JKljlkM', $getNetCfgRequest, 1);
    var_dump($response);
    Coroutine::sleep(3);
//    }
});