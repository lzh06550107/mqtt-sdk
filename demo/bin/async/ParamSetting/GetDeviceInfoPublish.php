...
use JuLongDeviceMqtt\ParamSetting\Models\DeviceInfoRequest;
...
$getDeviceInfoRequest = new DeviceInfoRequest();

Coroutine\run(function () use($paramSettingMqttClient, $getDeviceInfoRequest) {
//    while (true) {
    $paramSettingMqttClient->publish('fwSkNfgI4JKljlkM', $getDeviceInfoRequest, MQTT_QOS_0);
    Coroutine::sleep(3);
//    }
});